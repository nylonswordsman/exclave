...
comp-secret-stash-on-examine-found-hidden-item = There's something hidden in the {$stashname}...
comp-secret-stash-on-destroyed-popup = Something falls out of the {$stashname}...!

### Verbs
comp-secret-stash-verb-insert-into-stash = Stash Item
comp-secret-stash-verb-insert-message-item-already-inside = There's already an item in the {$stashname}.
...
comp-secret-stash-verb-take-out-message-nothing = There's nothing in the {$stashname}.
