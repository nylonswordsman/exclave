...
bloodstream-component-slight-bleeding = [color=#ffa8a8]{CAPITALIZE(SUBJECT($target))} {CONJUGATE-BE($target)} mildly bleeding.[/color]
...
bloodstream-component-wounds-cauterized = You feel your wounds close with a searing pain!
