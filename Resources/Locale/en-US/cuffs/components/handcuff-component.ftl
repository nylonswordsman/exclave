handcuff-component-target-self = You begin to tie your paws together...
handcuff-component-cuffs-broken-error = The restraints are broken!
handcuff-component-target-has-no-hands-error = {$targetName} has no paws!
handcuff-component-target-has-no-free-hands-error = {$targetName} has no free paws!
...
handcuff-component-cuff-self-success-message = You tighten the restraint around your own wrists.
