...
cuffable-component-start-uncuffing-self = You start to painfully wriggle your paws around in your restraints...
cuffable-component-start-uncuffing-observer = {$user} starts untying {$target}'s restraints...!
cuffable-component-start-uncuffing-self-observer = {$user} starts unrestraining {REFLEXIVE($target)}...!
cuffable-component-start-uncuffing-target-message = You start to untie {$targetName}'s restraints...
cuffable-component-start-uncuffing-by-other-message = {$otherName} starts unrestraining you...

cuffable-component-remove-cuffs-success-message = You untie the restraints.
cuffable-component-remove-cuffs-push-success-message = You untie the restraints and shove {$otherName} to the ground.
